 ...
 * Use the {@link ArtifactsFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ArtifactsFragment extends Fragment {

    private RecyclerView rvArtifacts;
    private RecyclerView.Adapter adArtifacts;
    private List<Artifacts> listArtifacts;
    private AdapterArtifacts adapterArtifacts;
    ...
    public static ArtifactsFragment newInstance(String param1, String param2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        rvArtifacts = getView().findViewById(R.id.rv_artifacts);
    ...
    private void retrieveQuote() {
        ...
        Call<List<Artifacts>> retrieveProcess = ardData.getArtifacts();
        retrieveProcess.enqueue(new Callback<List<Artifacts>>() {
            @Override
            public void onResponse(Call<List<Artifacts>> call, Response<List<Artifacts>> response) {
                listArtifacts = response.body();
                adapterArtifacts = new AdapterArtifacts(listArtifacts);
